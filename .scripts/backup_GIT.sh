...
sleep 0.1s ; git remote add origin ssh://git@github.com/diySascha/Ender3_Klipper_backup.git 1>> /home/pi/printer_data/config/Backuplogs/git_ready.log 2>> /home/pi/printer_data/config/Backuplogs/git_fail.log
sleep 0.1s ; git remote -v 1>> /home/pi/printer_data/config/Backuplogs/git_ready.log 2>> /home/pi/printer_data/config/Backuplogs/git_fail.log
...
echo GIT Repo adress: https://github.com/diySascha/Ender3_Klipper_backup
echo GIT Repo adress: https://github.com/diySascha/Ender3_Klipper_backup >> /home/pi/printer_data/config/Backuplogs/git_ready.log
log_date=(`date +%Y-%m-%d_%H:%M:%S`)
